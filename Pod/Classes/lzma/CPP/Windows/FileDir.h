...
namespace NWindows {
	namespace NFile {
		namespace NDirectory {
			...
			{ return MySetCurrentDirectory(path); }
			...
			bool MySearchPath(LPCTSTR path, LPCTSTR fileName, LPCTSTR extension, CSysString &resultPath, uint32_t &filePart);
#ifndef _UNICODE
			bool MySearchPath(LPCWSTR path, LPCWSTR fileName, LPCWSTR extension, UString &resultPath, uint32_t &filePart);
#endif
